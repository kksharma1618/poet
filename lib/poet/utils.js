 ...
 * @returns {Array}
 */
exports.fileModifiedTimes = {}; // storing all modified times in this. against file path
    ...
    return all(files.map(function (file) {
      ...
      return fs.stat(path).then(function (stats) {
        ...
        if(stats.isFile() && stats.mtime) {
            exports.fileModifiedTimes[path] = stats.mtime;
        }
...
function createPost (filePath, options, isPage) {
  ...
  return fs.readFile(filePath, 'utf-8').then(function (data) {
    ...
    post.fileModifiedTime = exports.fileModifiedTimes[filePath] ? exports.fileModifiedTimes[filePath] : false;
